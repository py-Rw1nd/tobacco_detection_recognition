...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/fold/fold3.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weight/s/5s_CA/weights/best.pt', help='model.pt path(s)')
