...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    scheduler.step()
    # summary(model, torch.rand(1, 3, 480, 640).cuda())
        # end epoch ----------------------------------------------------------------------------------------------------
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5n_ca.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/fold/fold4.yaml', help='dataset.yaml path')
