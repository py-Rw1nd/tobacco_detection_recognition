...
class Block(nn.Module):
    ...
    def __init__(self, kernel_size, in_size, expand_size, out_size, act, ca, stride):
        ...
        self.ca = CoordAtt(expand_size,expand_size) if ca else nn.Identity()
...
class MobileNetV3_Small_ca(nn.Module):
    def __init__(self, num_classes=1000, act=nn.Hardswish):
        super(MobileNetV3_Small_ca, self).__init__()
...
if __name__ == '__main__':
    net = MobileNetV3_Small_ca().to('cuda')
